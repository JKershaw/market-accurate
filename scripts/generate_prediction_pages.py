...
PREDICTIONS: list[Prediction] = [
    ...
    # ----- AI Software Development Automation & Reliability (5) -----
    Prediction(
        id="SD-001",
        ...
        why_matters="Reliability, not capability, is the thesis's claimed bottleneck for autonomous software production; a persistent high defect rate is the most direct test of it.",
        ...
        threshold="The next Veracode GenAI Code Security Report (or an equivalent controlled, multi-model benchmark — not field telemetry) published by Feb 28, 2027 shows AI-generated code introducing an OWASP-class vulnerability in ≥30% of evaluated tasks. Series = controlled benchmark, not PR/field telemetry; metric = % of tasks with an injected vulnerability.",
        base_rate="Veracode's Oct 2025 report found 45% of tasks introduced a vulnerability and that newer/larger models did not improve security. Base-rate probability the rate stays ≥30% in the next iteration: ~75%.",
        made="2026-06-13",
        resolves="2027-02-28",
    ...
    Prediction(
        ...
        why_matters="Separates autonomous production from AI-assistance; the popular 'engineers are now reviewers of digital labor' narrative requires this and it has not been demonstrated.",
        ...
        threshold="No credible disclosure (engineering blog from a top-50-by-revenue software company, SEC filing, or peer-reviewed study) by Dec 31, 2027 stating that >50% of merged production PRs were authored autonomously by AI with no human code edits. 'AI-assisted'/'AI-suggested' lines do not count; human review is allowed but human edits disqualify a PR from the autonomous count.",
        base_rate="No such disclosure exists as of mid-2026, and no rigorous public number for autonomous-PR-merge-without-rework exists at all. Base-rate probability the claim (no majority disclosure) holds through 2027: ~70%.",
        made="2026-06-13",
        resolves="2027-12-31",
        analysis_file="ai-software-automation-2026-06",
        analysis_title="AI Software Development Automation & Reliability",
    ...
    Prediction(
        ...
        why_matters="Tests the '10x engineer' claim against the strongest causal evidence; METR's 2025 RCT found experienced devs were actually slower.",
        ...
        threshold="A METR-class RCT or equivalent peer-reviewed/quasi-experimental study published by Dec 31, 2027 reports a central point-estimate speedup of <100% (i.e., <2x) for experienced developers on mature repositories. Point estimate, not a best-case subgroup. If no qualifying study publishes by the date, resolves INCONCLUSIVE.",
        base_rate="METR's July 2025 RCT found −19% (slower); the Feb 2026 follow-up argued for a likely-higher-but-unmeasured speedup. No controlled study to date has shown ≥2x for this cohort. Base-rate probability of <2x: ~78%.",
        made="2026-06-13",
        resolves="2027-12-31",
        analysis_file="ai-software-automation-2026-06",
        analysis_title="AI Software Development Automation & Reliability",
    ...
    Prediction(
        ...
        why_matters="The contrarian position to Dario Amodei's stated 70–80% odds of a $1B one-person company by 2026 — a clean test of hype vs realized outcome.",
        claim="No single-employee company will reach a $1B valuation or $1B annual revenue, credibly documented, by December 31, 2026.",
        threshold="No company with exactly one full-time human (the founder) is documented by WSJ/FT/Bloomberg/TechCrunch as having reached either (a) a $1B valuation in a priced funding round or (b) $1B annual revenue, on or before Dec 31, 2026. Contractors/AI agents permitted (per the popular framing).",
        base_rate="Largest documented solo-founder outcomes are low-tens-of-millions ARR (e.g., Base44 ~$3.5M ARR / ~$80M sale). A 20–30x jump to $1B within 2026 has no precedent. Base-rate probability the claim (no such company) holds: ~80%.",
        made="2026-06-13",
        resolves="2026-12-31",
        analysis_file="ai-software-automation-2026-06",
        analysis_title="AI Software Development Automation & Reliability",
    ...
    Prediction(
        ...
        why_matters="Tests whether AI coding disruption is aggregate or concentrated; the software-specific version of the Labor Market analysis's concentrated-not-aggregate finding.",
        ...
        threshold="BLS OES occupation 15-1252 'Software Developers' total employment in the 2026 OES release (published ~spring 2027) is ≥90% of the 2024 OES level. Aggregate occupation total (15-1252), not CES or LinkedIn, and explicitly not entry-level hiring flows.",
        base_rate="Aggregate software employment has been roughly flat-to-rising despite a sharp entry-level pullback; a >10% aggregate decline in one year would be unprecedented absent a recession. Base-rate probability of ≥90% retention: ~65%.",
        made="2026-06-13",
        resolves="2027-05-31",
        analysis_file="ai-software-automation-2026-06",
        analysis_title="AI Software Development Automation & Reliability",
